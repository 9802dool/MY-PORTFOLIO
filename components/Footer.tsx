          ...
          <div className="flex space-x-4">
            {socialLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="inline-flex items-center justify-center h-10 w-10 rounded-full bg-white/5 hover:bg-amber-600/20 text-gray-300 hover:text-white border border-white/10 hover:border-amber-500 transition-all duration-300"
